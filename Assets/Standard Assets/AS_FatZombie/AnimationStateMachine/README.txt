...
This copy of the Animation State Machine by Mixamo was trimmed down for use with this Arabian Studios character asset.
Please download the latest version of the Animation State Machine from the unity asset store ( http://u3d.as/1sM )
