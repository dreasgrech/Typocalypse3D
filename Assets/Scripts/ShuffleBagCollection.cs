...
public sealed class ShuffleBagCollection<T> : IEnumerable<T>
{
    ...
    /// </summary>
    public ShuffleBagCollection() : this(10, new Random())
    {
    }
    ...
    public ShuffleBagCollection(Random generator) : this(10, generator)
    {
    }
    ...
    public ShuffleBagCollection(int initialCapacity) : this(initialCapacity, new Random())
    {
    }
    ...
    /// <param name="generator">The random number generator to use</param>
    /// <exception cref="System.ArgumentException">Thrown if initialCapacity &lt; 0</exception>
    public ShuffleBagCollection(int initialCapacity, Random generator)
    {
