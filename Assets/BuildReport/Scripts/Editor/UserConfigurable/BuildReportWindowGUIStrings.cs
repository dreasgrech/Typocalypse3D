...
public partial class BuildReportWindow : EditorWindow
{
	...
	const string ASSET_SIZE_BREAKDOWN_MSG_POST_BOLD = "size. Click on name to select it in the Project window. Click on file size to include it in size calculations.";
